...
import IMG6 from "./images/img62.webp";
function App() {
        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Elegant watches</h1>
                    <p class="lead fw-normal text-white-50 mb-0">Let the Sun shine in your hand !!!</p>
                </div>
            </div>
        </header>
